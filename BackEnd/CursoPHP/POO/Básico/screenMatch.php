...
$nomeFilme = "Sonic";
$anoLancamento = 2025; // $anoLancamento = $argv[1] ?? 2025; // Estamos acessando o primeiro argumento passado no terminal (excluindo o nome do script). Se o usuário não passar nenhum argumento, $argv[1] será 2022 (valor passado como padrão).
